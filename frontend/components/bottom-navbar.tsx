/* eslint-disable jsx-a11y/click-events-have-key-events, jsx-a11y/no-static-element-interactions, jsx-a11y/interactive-supports-focus, jsx-a11y/no-noninteractive-element-interactions, jsx-a11y/no-noninteractive-element-to-interactive-role */
"use client"
    ...
    <>
      ...
      {menuOpen && (
        <button 
          ...
          className="fixed inset-0 z-[998] bg-black/40 backdrop-blur-sm md:hidden animate-fade-in w-full h-full text-left cursor-default" 
        ...
        >
          <dialog 
            open
            className="absolute bottom-20 left-4 right-4 bg-background/95 backdrop-blur-md rounded-3xl border border-border/60 p-5 shadow-2xl animate-slide-up space-y-4 m-0 w-[calc(100%-2rem)] max-w-none text-left"
