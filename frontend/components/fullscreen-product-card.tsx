...
export default function FullscreenProductCard({ product, onAddToCart }: Readonly<FullscreenProductCardProps>) {
            ...
            <div className="flex items-center gap-2">
              {colors.map((color: string) => (
                <button
                  ...
                  className={`w-9 h-9 rounded-full border transition-all flex items-center justify-center ${selectedColor === color
            ...
            <div className="flex items-center gap-1.5">
              {capacities.map((opt: string) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-bold transition-all ${selectedCapacity === opt
