...
export default function AdminSidebar({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "hidden lg:flex lg:flex-col lg:fixed lg:top-0 lg:bottom-0 lg:z-20 lg:bg-white lg:dark:bg-gray-900 transition-all duration-300 shadow-lg",
      ...
      <Sheet open={isMobileOpen} onOpenChange={setIsMobileOpen}>
        <SheetContent side="left" className="p-0 w-64 mt-0">
          <SidebarContent
            mobile
            isCollapsed={isCollapsed}
            setIsCollapsed={setIsCollapsed}
...
interface SidebarContentProps {
  ...
  readonly toggleExpanded: (title: string) => void
          ...
          <nav className="space-y-4 px-3">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1">
                {menuItems.filter(item => (item.title !== "Users" && item.title !== "Analytics") || user?.role === "super_admin").map((item) => {
