...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      {/* Mobile Header - positioned at top */}
      <div className="lg:hidden fixed top-0 left-0 right-0 h-14 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 z-30 flex items-center px-4 shadow-sm">
        <Button
          variant="ghost"
          size="sm"
      ...
      <main
        className={cn(
          ...
          // Desktop: account for sidebar width, add some breathing room at the top
          "lg:pt-8",
          !isMobile && (isCollapsed ? "lg:ml-16" : "lg:ml-64"),
          // Mobile: account for admin header (56px) + some breathing room
          "pt-20 lg:pt-8",
        )}
      >
