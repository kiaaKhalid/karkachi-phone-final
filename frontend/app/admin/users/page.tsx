...
export default function AdminUsersPage() {
  ...
  const handleUserUpdated = (updatedUser: Partial<UserDTO> & { id: string }) => {
  ...
  return (
    <div className="min-h-screen pt-16 sm:pt-20 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 -mb-8">
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between -mt-20 items-start md:items-center mb-10 gap-4">
          <div>
        ...
        <Card className="glass border-visible shadow-elegant">
          ...
          <CardContent>
            {loading || error ? (
              <UserTableSkeleton showActions={user?.role === "super_admin"} />
            ) : (
                      ...
                      <tr key={u.id} className="border-b border-visible hover:bg-secondary/50">
                        ...
                        <td className="py-4 px-2">
                          <Select
                            ...
                            disabled={u.id === user?.id || user?.role !== "super_admin"}
                          >
        ...
        <Dialog open={isAddingUser} onOpenChange={setIsAddingUser}>
          <DialogContent className="max-w-md">
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="newUser-name" className="text-sm font-medium text-high-contrast mb-2 block">Name *</label>
                <Input
                  id="newUser-name"
              ...
              <div>
                <label htmlFor="newUser-email" className="text-sm font-medium text-high-contrast mb-2 block">Email *</label>
                <Input
                  id="newUser-email"
                  type="email"
              ...
              <div>
                <label htmlFor="newUser-password" className="text-sm font-medium text-high-contrast mb-2 block">Password *</label>
                <Input
                  id="newUser-password"
                  type="password"
              ...
              <div>
                <label htmlFor="newUser-role" className="text-sm font-medium text-high-contrast mb-2 block">Role</label>
                <Select value={newUser.role} onValueChange={(value: string) => setNewUser({ ...newUser, role: value })}>
                  <SelectTrigger id="newUser-role" className="rounded-xl border-visible">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="USER">
...
function UserTableSkeleton({ showActions }: Readonly<{ showActions: boolean }>) {
  return (
    <div className="space-y-4">
      {skeletonIds.map((id) => (
