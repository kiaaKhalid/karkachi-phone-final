      ...
      <div className="w-full max-w-md">
        <Card className="backdrop-blur-sm bg-white/80 dark:bg-gray-900/80 border border-gray-200/50 dark:border-gray-700/50 shadow-2xl">
          <CardHeader className="space-y-1 text-center">
            ...
            <div className="flex justify-center space-x-2 mb-4">
              {[1, 2, 3].map((step) => {
                let stepClass = "bg-gray-200 dark:bg-gray-700 text-gray-500"
                if (step === currentStep) {
                  stepClass = "bg-orange-600 text-white"
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-center pt-4">
              <Link
                href="/auth/login"
                className="text-sm text-orange-600 hover:text-orange-500 dark:text-orange-400 dark:hover:text-orange-300 flex items-center justify-center space-x-1 transition-colors"
              >
